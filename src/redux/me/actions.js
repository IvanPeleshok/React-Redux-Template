...
export const register = (username, email, password, passConfirmation) => async (dispatch) => {
    let response = await userAPI.register(username, email, password, passConfirmation);
